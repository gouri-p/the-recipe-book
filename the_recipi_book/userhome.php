...
<body class="body">
  ...
  <header>
   ...
   <a class="navbar-brand text-white" href="/the_recipi_book/userhome.php">Home</a>
...
<div class="container">
    <h1 class="text-white">Reciepies you may like</h1></br>
    <?php
    ...
    <div class="cards">
        ...
        foreach ($rows as $row)
        {
            ...
            // echo '<a href="view.php?recipi='.$row['recipi'].'" class="btn btn-info"/>view recipi</a>';
            // echo '<a href="delete.php?recipi='.$row['recipi'].'" class="btn btn-danger"/>delete</a>';
            echo '</div></p>';
            echo '</div>';
            echo '</div>';
        };
