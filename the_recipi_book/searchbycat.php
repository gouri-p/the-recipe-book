...
$stmt = $pdo->query("SELECT recipi,ingrediants,steps,foodfile,tips FROM recipies where email='$email'");
...
<div class="container">
    ...
    <div class="cards">
          ...
          foreach ($rows as $row)
        {
            ...
            echo '<a href="delete.php?recipi='.$row['recipi'].'" class="btn bg-wite text-black border-dark"/>delete</a>';
            echo '</div></p>';
            echo '</div>';
            echo '</div>';
        };
